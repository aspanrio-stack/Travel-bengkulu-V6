...
const breadcrumbJsonLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Lampung–Bengkulu",
      "item": "https://bengkulutravel.com/travel-lampung-bengkulu"
    }
  ]
};
    ...
    >
      ...
      <section style={{marginTop: "2rem", padding: "1.25rem", background: "#f0f9f0", borderRadius: "8px", borderLeft: "4px solid #16a34a"}}>
        ...
        <ul style={{listStyle: "none", padding: 0, margin: 0, display: "flex", flexWrap: "wrap", gap: "0.5rem"}}>
          <li><Link href="/travel-bengkulu-lampung" style={{color: "#16a34a", textDecoration: "underline"}}>Travel Bengkulu → Lampung</Link></li>
