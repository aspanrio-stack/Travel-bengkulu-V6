...
export const metadata: Metadata = {
  title: 'Travel Palembang - Bengkulu Murah 2026 | Door to Door + Jemput Gratis',
  description:
    'travel Palembang Bengkulu door to door. Tarif Rp 250.000/orang. Berangkat setiap hari. Mobil Hiace, Innova bisa bayar pakai QRIS!',
...
const breadcrumbJsonLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Palembang–Bengkulu",
      "item": "https://bengkulutravel.com/travel-palembang-bengkulu"
    }
  ]
};
    ...
    >
      ...
      <section style={{marginTop: "2rem", padding: "1.25rem", background: "#f0f9f0", borderRadius: "8px", borderLeft: "4px solid #16a34a"}}>
        ...
        <ul style={{listStyle: "none", padding: 0, margin: 0, display: "flex", flexWrap: "wrap", gap: "0.5rem"}}>
          <li><Link href="/travel-bengkulu-palembang" style={{color: "#16a34a", textDecoration: "underline"}}>Travel Bengkulu → Palembang</Link></li>
