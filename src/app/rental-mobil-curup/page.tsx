...
export default function RentalMobilCurup() {
  return (
    ...
    >
      ...
      <ol>
        <li>Klik tombol <strong>"Pesan Rental Sekarang"</strong> di bawah</li>
        <li>Pilih armada dan tanggal penyewaan</li>
        <li>Isi data diri dan lokasi pengambilan</li>
        <li>Bayar via QRIS atau konfirmasi via WhatsApp</li>
        <li>Siapkan KTP dan SIM A asli saat unit diserahkan</li>
      </ol>
      ...
      <div className="not-prose mt-8 flex flex-col sm:flex-row gap-3">
        <a
          ...
          className="flex-1 bg-primary-700 hover:bg-primary-800 text-white font-bold py-4 px-6 rounded-xl text-center text-base transition-colors"
        >
          🚗 Pesan Rental Sekarang
        </a>
        <a
          href="https://wa.me/6285268645461?text=Halo%2C+saya+mau+tanya+rental+mobil+di+Curup"
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-6 rounded-xl text-center text-base transition-colors"
        >
          💬 Tanya via WhatsApp
        </a>
      </div>
