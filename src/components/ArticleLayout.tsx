            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="bg-primary-600 rounded-2xl p-6 text-white">
                ...
                <a
                  ...
                  className="w-full bg-green-400 hover:bg-green-300 text-slate-900 font-bold px-5 py-3 rounded-xl flex items-center justify-center gap-2 transition-colors" aria-label="Hubungi via WhatsApp"
                >
