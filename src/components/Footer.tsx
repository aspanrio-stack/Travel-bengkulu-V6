      ...
      <div className="max-w-7xl mx-auto px-4 py-14 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="md:col-span-1">
          ...
          <div className="mt-4 flex gap-3">
            <a href={WA} target="_blank" rel="noopener noreferrer" aria-label="Hubungi Travel Bengkulu via WhatsApp" className="w-9 h-9 bg-green-500 hover:bg-green-600 rounded-lg flex items-center justify-center transition-colors">
